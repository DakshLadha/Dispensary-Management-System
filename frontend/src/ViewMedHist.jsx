    ...
    render() {
        ...
        const Header = () => (
            <Box
                ...
                flex={false}
            >
               <a style={{ color: 'inherit', textDecoration: 'inherit'}} href="/"><Heading level='3' margin='none'>DMS</Heading></a>
                        ...
                        <tbody>
                            {medhiststate.map(patient =>
                                <tr key={patient.id} style={{textAlign:"center"}}>
                                    <td>{patient.Name} </td>
                                    <td>
                                        <Button label="Medical Profile" href={'/ViewOneHistory/' + btoa(patient.email)}/>
                                    </td>
                                </tr>
                            )}
                        </tbody>
